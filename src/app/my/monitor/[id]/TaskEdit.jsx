...
export default function TaskEdit({ taskItemData, setTaskItemData, setShowEditTask }) {
  const router = useRouter();
  const [task, setTask] = useState(taskItemData.task);
  const [description, setDescription] = useState(taskItemData.description);
  ...
  const handleSubmitEdit = (e) => {
    ...
    request
      .put(`monitor-task/${taskItemData.id}`, {
        task: task,
        description: description,
        monitorId: taskItemData.monitorId,
      })
      .then(function (res) {
    ...
    <>
      ...
      <section className="sm:ml-12 md:ml-16 lg:ml-20 sm:px-10 pb-20">
        <div className="flex justify-between items-center sm:px-0 lg:py-4 md:py-3 py-2 sm:mx-0 mx-4">
          <button type="button" onClick={() => setShowEditTask(false)} className="flex justify-center items-center lg:gap-6 gap-3">
        ...
        <div className="xl:px-20 lg:px-16 md:px-14 sm:px-12 px-10">
          <div>
            ...
            <h4 className="text-gcSecondary-600 gcContentBody4p">{formatDateToIndonesian(taskItemData.createdAt)}</h4>
          </div>
