    ...
    <>
      ...
      <section className="sm:ml-12 md:ml-16 lg:ml-20 lg:px-14 md:px-12 sm:px-10 px-4 mb-20">
        ...
        <div className="mt-5">
          ...
          <div className="flex flex-col m-auto p-auto sm:mt-3 mt-1.5 relative group/item">
                  ...
                  return (
                    <div key={article.id} className="inline-block">
                      <div className="w-80 max-w-xs overflow-hidden rounded-lg transition-shadow duration-300 ease-in-out pb-2">
                        <img className="rounded-xl object-cover object-center xl:h-44 lg:h-40 md:h-36 h-32 w-full mb-2" src={article.image} alt={article.slug} />
