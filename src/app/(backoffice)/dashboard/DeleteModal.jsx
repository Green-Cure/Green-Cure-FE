export default function DeleteModal({ toggleDelete, handleToggleDeleteModal, handleDelete, id }) {
  return (
      ...
      <div className="relative p-4 w-full max-w-md max-h-full m-auto">
        <div className="relative bg-white rounded-lg shadow">
          ...
          <div className="p-4 md:p-5 text-center">
            ...
            <h3 className="mb-5 text-lg font-normal text-gray-500">Are you sure you want to delete this article?</h3>
            <button
              data-modal-hide="popup-modal"
              type="button"
